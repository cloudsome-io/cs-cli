...
type UnsetLabelCommand struct {
	...
	usage           interface{}         `usage:"CF_NAME unset-label RESOURCE RESOURCE_NAME KEY...\n\nEXAMPLES:\n   CF_NAME unset-label app dora ci_signature_sha2\n   CF_NAME unset-label org business pci public-facing\n   CF_NAME unset-label buildpack go_buildpack go -s cflinuxfs4\n\nRESOURCES:\n   app\n   buildpack\n   domain\n   org\n   route\n   service-broker\n   service-offering\n   service-plan\n   space\n   stack"`
