...
type CreateUserCommand struct {
	...
	usage           interface{}     `usage:"CF_NAME create-user USERNAME PASSWORD\n   CF_NAME create-user USERNAME [--origin ORIGIN]\n   CF_NAME create-user USERNAME --password-prompt\n\nEXAMPLES:\n   CF_NAME create-user j.smith@example.com S3cr3t                  # internal user\n   CF_NAME create-user j.smith@example.com --origin ldap           # LDAP user\n   CF_NAME create-user j.smith@example.com --origin provider-alias # SAML or OpenID Connect federated user"`
