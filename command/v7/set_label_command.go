...
type SetLabelCommand struct {
	...
	usage           interface{}       `usage:"CF_NAME set-label RESOURCE RESOURCE_NAME KEY=VALUE...\n\nEXAMPLES:\n   CF_NAME set-label app dora env=production\n   CF_NAME set-label org business pci=true public-facing=false\n   CF_NAME set-label buildpack go_buildpack go=1.12 -s cflinuxfs4\n\nRESOURCES:\n   app\n   buildpack\n   domain\n   org\n   route\n   service-broker\n   service-offering\n   service-plan\n   space\n   stack"`
